...
.. admonition:: Under construction
   ...
   Dashboard: basic configuration in ASP.NET, ASP.NET Core and OWIN.SelfHost; authorization, nginx, aspnetcore, microsoft.owin.host.systemweb; integration (path, application path), catching dashboard errors, .NET Core catch ups, adding dashboard metrics, pages, routes, actions, menu items, metrics, tuning (polling interval, job list limit).
